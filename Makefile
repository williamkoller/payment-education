IGNORED_DIRS := internal/.*/router|shared/.*/event|cmd|internal/.*/domain/port/|pkg/logger|pkg/ulid|shared/middleware|internal/.*/model|config|internal/.*/presentation|shared.*/infra/email
